...
<head>
	<meta charset="UTF-8">
	<title>Edit Lowongan Kerja | Sistem Informasi Ikatan Alumni UII</title>
	...
	<div class="wrapper w80">
		<div id="edit-area">
			<div id="post-message"></div>
				<form action="<?php echo $app->base_url('admin/articles/articlesControl.php'); ?>" method="POST" id="uii-form" class="loker-edit">
				<?php
